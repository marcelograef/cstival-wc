...
import { getData, getRealPositionLong, getRealPositionShort, saveRange } from '../../utilities';
	...
	const handleSave = async () => {
		try {
			const res = await saveRange({
				...
				situation,
				...tableValues,
				info: { ...tableValues.info, messages: tableValues.info.messages.filter(m => m.trim()!== '') }
			});
			console.log(res);
